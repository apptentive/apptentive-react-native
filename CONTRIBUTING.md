...
To edit the Objective-C files, open `example/ios/ApptentiveExample.xcworkspace` in XCode and find the source files at `Pods > Development Pods > react-native-apptentive`.

To edit the Kotlin files, open `example/android` in Android studio and find the source files at `reactnativeapptentive` under `Android`.
